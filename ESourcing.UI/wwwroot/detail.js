...
var connection = new signalR.HubConnectionBuilder().withUrl("http://localhost:65189/auctionhub").build();
...
connection.start().then(function () {
    ...
    connection.invoke("AdToGroupAsnyc", groupName).catch(function (err) {
    ...
    $.ajax({
        ...
        success: function (response) {
            if (response.isSuccess) {
                ...
                connection.invoke("SendBidAsnyc", groupName, model.SellerUserName, model.Price).catch(function (err) {
                    return console.error(err.toString());
                });
            }
        },
    ...
    $.ajax({
        ...
        success: function (response) {
            if (response) {
                ...
                location.href = "http://localhost:65189/Auction/Index";
            }
        },
        error: function (jqXHR, textStatus, errorThrown) {
            console.log(textStatus, errorThrown);
